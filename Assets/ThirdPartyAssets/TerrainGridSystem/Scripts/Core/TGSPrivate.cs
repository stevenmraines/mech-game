...
namespace TGS {
    ...
    public partial class TerrainGridSystem : MonoBehaviour {
        ...
        Dictionary<Color, Material> coloredMatCacheGroundCell;
        Dictionary<Color, Material> coloredMatCacheOverlayCell;
        ...
        void SetStencil(Material mat, int stencilMask) {
            if (mat == null) return;
            mat.SetInt("_StencilRef", stencilMask);
        ...
        Material GetColoredTexturedMaterialForCell(Color color, Texture2D texture, bool overlay) {
            Dictionary<Color, Material> matCache = overlay ? coloredMatCacheOverlayCell : coloredMatCacheGroundCell;
        ...
        Material GetColoredTexturedMaterialForTerritory(Region region, Color color, Texture2D texture, bool overlay) {
            ...
            customMat.color = color;
            customMat.mainTexture = texture;
            customMat.SetFloat("_Offset", _gridSurfaceDepthOffsetTerritory);
        ...
        void DrawCellBorders() {
            ...
            cellsGeoMat.SetFloat("_Thickness", thick);
        }
        ...
        bool CheckMousePos() {
            ...
            if (_territoryRegionLastOver != null) {
                if (_territoryLastOver.visible && _territoryRegionLastOver.Contains(localPoint.x, localPoint.y)) {
