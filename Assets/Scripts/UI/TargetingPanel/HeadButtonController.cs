...
{
    public class HeadButtonController : AbsMechPartButtonController
    {
        ...
        public override void OnButtonClick()
        {
            ...
            OnButtonClickReroute?.Invoke(_activeUnit, _targetUnit, targetMech.GetComponent<Head>());
        }
        ...
        public override void SetUnits(IUnit activeUnit, IUnit targetUnit)
        {
            ...
            if(_targetUnit is MechController)
                SetButtonColorAndText(((MechController)_targetUnit).GetComponent<Head>());
        }
    }
}
