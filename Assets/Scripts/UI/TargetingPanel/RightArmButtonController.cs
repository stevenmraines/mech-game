...
{
    public class RightArmButtonController : AbsMechPartButtonController
    {
        ...
        public override void OnButtonClick()
        {
            ...
            OnButtonClickReroute?.Invoke(_activeUnit, _targetUnit, targetMech.GetComponent<RightArm>());
        }
        ...
        public override void SetUnits(IUnit activeUnit, IUnit targetUnit)
        {
            ...
            if(_targetUnit is MechController)
                SetButtonColorAndText(((MechController)_targetUnit).GetComponent<RightArm>());
        }
    }
}
